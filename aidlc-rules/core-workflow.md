...
- `.aidlc/aidlc-rules/aidlc-rule-details/` (typical with AI-assisted setup)
- `.aidlc-rule-details/` (typical with Cursor, Cline, Claude Code, GitHub Copilot, OpenAI Codex)
- `.kiro/aidlc-rule-details/` (typical with Kiro IDE and CLI)
- `.amazonq/aidlc-rule-details/` (typical with Amazon Q Developer)
